...
Connect::Connect( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText3 = new wxStaticText( this, wxID_ANY, _("Host:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText3->Wrap( -1 );
	gbSizer1->Add( m_staticText3, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_server = new wxComboBox( this, wxID_ANY, _("localhost"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 ); 
	gbSizer1->Add( m_server, wxGBPosition( 0, 1 ), wxGBSpan( 1, 5 ), wxALL|wxEXPAND, 5 );
	
	m_staticText4 = new wxStaticText( this, wxID_ANY, _("Port:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText4->Wrap( -1 );
	gbSizer1->Add( m_staticText4, wxGBPosition( 1, 0 ), wxGBSpan( 1, 1 ), wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_port = new wxComboBox( this, wxID_ANY, _("4000"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	m_port->Append( _("4000") );
	m_port->Append( _("23") );
	gbSizer1->Add( m_port, wxGBPosition( 1, 1 ), wxGBSpan( 1, 1 ), wxALL|wxEXPAND, 5 );
	gbSizer1->AddGrowableCol( 1 );
	sbSizer2->Add( gbSizer1, 1, wxALL|wxEXPAND, 5 );
	...
	m_sdbSizer1->Realize();
	bSizer5->Add( m_sdbSizer1, 0, wxALIGN_BOTTOM|wxALL|wxEXPAND|wxTOP, 5 );

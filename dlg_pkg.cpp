...
dlg_pkg::dlg_pkg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_choice = new wxChoice( sbSizer1->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceNChoices, m_choiceChoices, 0 );
	m_choice->SetSelection( 0 );
	sbSizer1->Add( m_choice, 0, wxALL|wxEXPAND, 5 );
	
	wxString m_groupsChoices[] = { _("All") };
	int m_groupsNChoices = sizeof( m_groupsChoices ) / sizeof( wxString );
	m_groups = new wxChoice( sbSizer1->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_groupsNChoices, m_groupsChoices, 0 );
	m_groups->SetSelection( 0 );
	sbSizer1->Add( m_groups, 0, wxALL|wxEXPAND, 5 );
	...
	m_items = new wxCheckListBox( sbSizer2->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_itemsChoices, wxLB_NEEDED_SB );
	m_items->SetMinSize( wxSize( 400,300 ) );
	
	sbSizer2->Add( m_items, 2, wxALL|wxEXPAND, 5 );
	
	m_checkall = new wxCheckBox( sbSizer2->GetStaticBox(), wxID_ANY, _("Check all items"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pkgfile = new wxFilePickerCtrl( sbSizer3->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"), wxT("*.*|*.lua"), wxDefaultPosition, wxDefaultSize, wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	...
	m_groups->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( dlg_pkg::OnGroups ), NULL, this );
...
dlg_pkg::~dlg_pkg()
{
	...
	m_groups->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( dlg_pkg::OnGroups ), NULL, this );

...
scriptedit::scriptedit( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	sbSizer1->Add( m_sce, 1, wxALIGN_CENTER_HORIZONTAL|wxALL|wxEXPAND, 5 );
	...
	m_file->Wrap( -1 );
	bSizer3->Add( m_file, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
	...
	bSizer8->Add( bSizer4, 0, wxALIGN_RIGHT|wxALL|wxEXPAND, 5 );
